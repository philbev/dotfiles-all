# Generated by Powerlevel10k configuration wizard on 2020-11-01 at 10:42 GMT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 47272.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, round separators, round heads, round tails, 2 lines, dotted, full frame,
# light-ornaments, compact, many icons, concise, transient_prompt, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=166
  ...
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_BACKGROUND=196
  # Text and color for visual vi mode.
  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING=VISUAL
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_BACKGROUND=63
  ...
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_BACKGROUND=8
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=166
