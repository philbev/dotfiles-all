...
if has('nvim')
	nnoremap <buffer> <F10> :edit ~/.local/share/nvim/site/after/ftplugin/cpp.vim<CR>
	nnoremap <buffer> <F22> :source ~/.local/share/nvim/site/after/ftplugin/cpp.vim<CR>
setlocal spellfile=~/.local/share/nvim/site/spell/en.utf-8.add,~/.local/share/nvim/site/spell/cpp.utf-8.add
else
	nnoremap <buffer> <F10> :edit ~/.vim/after/ftplugin/cpp.vim<CR>
	nnoremap <buffer> <S-F10> :source ~/.vim/after/ftplugin/cpp.vim<CR>
...
augroup cpp_1
	autocmd!
	if has('nvim')
	autocmd BufWritePost <buffer> source ~/.local/share/nvim/site/after/ftplugin/cpp.vim
    else
	autocmd BufWritePost <buffer> source ~/.vim/after/ftplugin/cpp.vim
    endif
augroup END
...
nnoremap <buffer> <M-O>3P :echo "\t\tFUNCTION KEYS\n
		...
		\<SHIFT>-<F10>\t- Source ~/.vim/after/ftplugin/cpp.vim.\n
		\<F10>\t\t- Edit ~/.vim/after/ftplugin/cpp.vim.\n
