...
if has('nvim')
    nnoremap <buffer> <F10> :edit ~/.local/share/nvim/site/after/ftplugin/snippets.vim<CR>
    nnoremap <buffer> <F22> :source ~/.local/share/nvim/site/after/ftplugin/snippets.vim<CR>
else
    nnoremap <buffer> <F10> :edit ~/.vim/after/ftplugin/snippets.vim<CR>
    nnoremap <buffer> <S-F10> :source ~/.vim/after/ftplugin/snippets.vim<CR>
endif
