"File /home/philbev/.vim/after/ftplugin/html.vim
...
if has('nvim')
    ...
    nnoremap <buffer> <F10> :edit ~/.vim/after/ftplugin/html.vim<CR>
    nnoremap <buffer> <S-F10> :source ~/.vim/after/ftplugin/html.vim<CR>
...
augroup html_1
    autocmd!
    if has('nvim')
	autocmd BufWritePost <buffer> source ~/.local/share/nvim/site/after/ftplugin/html.vim
    else
	autocmd BufWritePost <buffer> source ~/.vim/after/ftplugin/html.vim
    endif
augroup END
